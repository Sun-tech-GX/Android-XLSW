...
public class BottomAniHandler extends Handler {
    ...
    public void handleMessage(){
        //步行 72m/min 自行车 250m/min 电动车 333m/min
        textView.setText("距离 "+new DecimalFormat("#").format(MyGraph.getDistance())+" M 步行约 "+new DecimalFormat("#").format(MyGraph.getDistance()/72)+" min");
