...
public class MainActivity extends BaseActivity {
     ...
     * 该线程用于实时更新用户位置信息
    */
    private static Thread thread = new Thread(){//该线程用于导航时
        @Override                //实时更新用户位置信息
        public void run() {
            while (true){
                if(threadFlag == true){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);//布局layout_main
        ...
        final FloatingActionButton actionB = findViewById(R.id.action_b);//地标全览
        actionB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Draw.drawPoints(mBaiduMap,Arrays.copyOfRange(MyGraph.points,1,30));//array中的[1,7)
        ...
        final FloatingActionButton actionA = findViewById(R.id.action_a);//我的位置
        ...
        Toast.makeText(MainActivity.this,"请确保您已开启GPS",Toast.LENGTH_SHORT).show();
    }
